...
/**
 * A player password generated by the server. Only the hash is stored, so this is the one
 * moment the plaintext exists: the admin prints or copies it before closing the sheet.
 */
...
export interface ClientToServerEvents {
  // Refused while a question is live, unless endLiveQuestion asks for it to be closed first.
  'admin:start_round': (data: { roundId: string; endLiveQuestion?: boolean }) => void;
